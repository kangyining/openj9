		...
		jlong ghostFileLimit)
{
	...
	if (vmFuncs->isCheckpointAllowed(currentThread) && setupCRIU) {
		...
		j9tty_printf(PORTLIB, "CP2\n\n\n");
		vmFuncs->internalEnterVMFromJNI(currentThread);
		j9tty_printf(PORTLIB, "CP3\n\n\n");
